...
>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <img
                  class="h-[1.5rem] w-[1.5rem] relative overflow-hidden shrink-0 min-h-[1.5rem]"
                  alt=""
                  src="./indonesia.png"
                />
          ...
          <div
            class="w-[42.438rem] flex flex-row items-start justify-start gap-[0.925rem] max-w-full text-[1rem] text-black"
          >
            <div
              class="h-[2.75rem] w-[2.75rem] rounded-981xl bg-white box-border overflow-hidden shrink-0 flex flex-row items-center justify-center p-[0.625rem] cursor-pointer border-[1px] border-solid border-gainsboro-200"
              id="cartBTNContainer"
            >
              <img
                class="h-[1.5rem] w-[1.2rem] relative"
                alt=""
                src="./indonesia.png"
              />
            </div>
            ...
            <div
              class="h-[2.75rem] w-[2.75rem] rounded-981xl bg-white box-border overflow-hidden shrink-0 flex flex-row items-center justify-center py-[0.625rem] px-[0.562rem] border-[1px] border-solid border-gainsboro-200"
            >
              <img
                class="h-[1.5rem] w-[1.5rem] relative"
                alt=""
                src="./indonesia.png"
              />
            </div>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="h-[31.063rem] w-full absolute !m-[0] top-[-9.375rem] right-[0rem] left-[0rem]"
        >
          <img
            class="absolute top-[-1.162rem] left-[0rem] w-[110rem] h-[32.225rem] object-cover"
            alt=""
            src="./indonesia.png"
          />

          <img
            class="absolute top-[29.669rem] left-[53.544rem] w-[2.919rem] h-[0.631rem] z-[1]"
            alt=""
            src="./indonesia.png"
          />
        </div>
        ...
        <h1
          class="m-0 relative text-inherit tracking-[0.03em] uppercase font-extrabold font-inherit z-[1] ml-[-14.938rem] mq450:text-[2.438rem] mq825:text-[3.25rem]"
        >
          Sunwa
        </h1>
      </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img
              class="h-[2.813rem] w-[2.813rem] relative min-h-[2.813rem]"
              alt=""
              src="./indonesia.png"
            />

            <img
              class="h-[2.813rem] w-[2.963rem] relative hidden min-h-[2.813rem]"
              alt=""
              src="./indonesia.png"
            />
            ...
            <div class="h-[2.75rem] relative tracking-[0.03em] inline-block">
              <p class="m-0 uppercase font-medium">easiness</p>
              <p class="m-0 text-[1.125rem] text-darkslategray">
                Financial transactions
              </p>
            </div>
          </div>
          <div
            class="flex-[0.6824] box-border overflow-hidden flex flex-row items-start justify-start py-[1.5rem] pr-[3.937rem] pl-[4.393rem] gap-[0.875rem] min-w-[14.688rem] max-w-full border-[1px] border-solid border-gainsboro-200 mq450:pl-[1.25rem] mq450:pr-[1.25rem] mq450:box-border mq450:flex-1 mq825:flex-wrap"
          >
            <img
              class="h-[2.813rem] w-[2.813rem] relative hidden min-h-[2.813rem]"
              alt=""
              src="./indonesia.png"
            />

            <img
              class="h-[2.813rem] w-[2.963rem] relative min-h-[2.813rem]"
              alt=""
              src="./indonesia.png"
            />
            ...
            <div
              class="h-[2.75rem] relative tracking-[0.03em] font-medium inline-block"
            >
              <p class="m-0 uppercase">support</p>
              <p class="m-0 text-[1.125rem] text-gray">24 hour on day</p>
            </div>
          </div>
          <div
            class="flex-[0.7119] box-border overflow-hidden flex flex-row items-start justify-start py-[1.5rem] pr-[3.687rem] pl-[4.131rem] gap-[0.868rem] min-w-[14.688rem] max-w-full border-[1px] border-solid border-gainsboro-200 mq450:pl-[1.25rem] mq450:pr-[1.25rem] mq450:box-border mq450:flex-1 mq825:flex-wrap"
          >
            <img
              class="h-[2.813rem] w-[2.813rem] relative hidden min-h-[2.813rem]"
              alt=""
            ...
            <div class="h-[2.75rem] relative tracking-[0.03em] inline-block">
              <p class="m-0 uppercase font-medium">freeship</p>
              <p class="m-0 text-[1.125rem] text-gray">Within the city</p>
            </div>
          </div>
          <div
            class="flex-1 box-border overflow-hidden flex flex-row items-start justify-center py-[1.5rem] pr-[1.25rem] pl-[1.562rem] gap-[0.937rem] min-w-[14.688rem] max-w-full border-[1px] border-solid border-gainsboro-200 mq450:flex-wrap"
          >
            <img
              class="h-[2.813rem] w-[2.813rem] relative hidden min-h-[2.813rem]"
              alt=""
            ...
            <div class="relative tracking-[0.03em]">
              <p class="m-0 uppercase font-medium">Warranty</p>
              <p class="m-0 text-[1.125rem] text-gray">+ 365 days</p>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <div class="h-[2.6rem] w-[3.088rem] relative">
              <div
                class="absolute top-[0rem] left-[0rem] bg-mediumseagreen-200 w-[1.563rem] h-[2.6rem]"
              ></div>
              <img
                class="absolute top-[0rem] left-[1.563rem] w-[1.525rem] h-[2.6rem] object-contain z-[1]"
                alt=""
                src="./indonesia.png"
              />
            </div>
        ...
        >
          ...
          >
            ...
            <img
              class="h-[2.5rem] w-[2.5rem] absolute !m-[0] bottom-[-1.131rem] left-[57.5rem] overflow-hidden shrink-0"
              loading="lazy"
              alt=""
              src="./indonesia.png"
            />
            ...
            <img
              class="h-[2.5rem] w-[2.5rem] absolute !m-[0] right-[57.625rem] bottom-[-1.131rem] overflow-hidden shrink-0 object-contain"
              alt=""
              src="./indonesia.png"
            />
          </div>
          <div
            class="w-full h-full absolute !m-[0] top-[0rem] right-[0rem] bottom-[0rem] left-[0rem] bg-silver z-[1]"
          ></div>
        </div>
      </div>
    </div>
  ...
  <div
    class="w-[63.438rem] h-[12.688rem] relative shadow-[0px_4px_6px_rgba(0,_0,_0,_0.25)] bg-white overflow-x-auto shrink-0 hidden max-w-full"
  >
    <div
      ...
      >
        ...
        >
          <div class="h-[0rem] w-[0rem] relative">
            <div
              class="absolute top-[0.156rem] left-[0.156rem] rounded-sm bg-mediumseagreen-200 w-full h-full"
            ></div>
            <div
              class="absolute top-[0rem] left-[0rem] rounded-sm box-border w-full h-full border-[1px] border-solid border-mediumseagreen-200"
            ></div>
          </div>
          <b
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <p class="m-0">
                  ...
                  market trends, and utilize our global network to provide our
                  customers with the most up-to-date information, the best
                  products, and the most reliable services. In cooperation with
                  our manufacturing partners, it is our mission to promote
                  industry and foster a prosperous society.” The “sun” in SUN-WA
                  can be read as the sun in the sky, representing future
                  prosperity for our company. SUN-WA is also the transliteration
                  of the Japanese “三和” meaning “three in harmony.”
                </p>
                <p class="m-0">
                  Since SUN-WA was founded, the three elements that our company
                  has strived to keep in harmony and develop are our customers,
                  our shareholders and our employees; as well as electrics,
                ...
                <p class="m-0">
                  ...
                  products, and the most reliable services. In cooperation with
                  our manufacturing partners, it is our mission to promote
                  industry and foster a prosperous society.”
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                <div
                  class="flex-1 relative text-[1rem] tracking-[0.03em] uppercase font-roboto text-seagreen text-center"
                >
                  read more
                </div>
              </button>
        ...
        <img
          class="h-[35rem] flex-1 relative max-w-full overflow-hidden object-cover min-w-[34.875rem] mq825:min-w-full"
          loading="lazy"
          alt=""
          src="./indonesia.png"
        />
      ...
      >
        <div class="flex flex-row items-start justify-start gap-[0.618rem]">
          <div class="h-[2.6rem] w-[3.088rem] relative">
            <div
              class="absolute top-[0.031rem] left-[0rem] bg-mediumseagreen-200 w-[1.563rem] h-[2.544rem]"
            ></div>
            <img
              class="absolute top-[0rem] left-[1.563rem] w-[1.525rem] h-[2.6rem] object-contain z-[1]"
              alt=""
            ...
            >
              ...
              >
                <div class="flex-1 relative tracking-[0.03em]">
                  <p
                    class="[margin-block-start:0] [margin-block-end:4px] uppercase"
                  >
                    09/01/2022
                  </p>
                  <p class="m-0 text-[0.938rem] font-medium">
      ...
      >
        ...
        >
          ...
          >
            <div
              class="h-[2.6rem] flex-1 bg-gainsboro-200 min-w-[21.188rem] max-w-full mq825:min-w-full"
            ></div>
            <img
              class="h-[2.6rem] w-[1.525rem] relative object-contain min-h-[2.625rem]"
              alt=""
              src="./indonesia.png"
            />
          </div>
          ...
          <img
            class="h-[2.6rem] w-[32.338rem] object-contain min-h-[2.625rem] max-w-full"
            loading="lazy"
            alt=""
            src="./indonesia.png"
          />
        ...
        >
          ...
          >
            ...
            >
              ...
              <img
                class="h-[3.238rem] w-[19.406rem] relative shrink-0 object-cover"
                loading="lazy"
                alt=""
                src="./indonesia.png"
              />
          ...
          <img
            class="h-[0.313rem] flex-1 relative max-w-full overflow-hidden z-[1] ml-[-109.938rem]"
            loading="lazy"
            alt=""
            src="./indonesia.png"
          />
  ...
  >
    ...
    >
      <img
        class="absolute top-[1.6rem] left-[14.313rem] w-[129.225rem] h-[18.525rem] object-cover"
        loading="lazy"
        alt=""
        src="./indonesia.png"
      />
      ...
      <img
        class="absolute top-[0rem] left-[-2.437rem] w-[124.944rem] h-[19.225rem] mix-blend-normal z-[1]"
        alt=""
        src="./indonesia.png"
      />
    </div>
    <h1
      class="m-0 relative text-inherit font-extrabold font-inherit z-[2] mq450:text-[1.688rem] mq825:text-[2.25rem]"
    >
      FOLLOW US
    </h1>
    <div
    ...
    >
      ...
      >
        ...
        <div
          class="h-[2.813rem] [background:linear-gradient(180deg,_#f1f1f1,_#e5e5e5)] overflow-hidden hidden flex-row items-center justify-center py-[0.625rem] px-[0.937rem] box-border gap-[0.625rem]"
        >
          <img
            class="h-[0.938rem] w-[0.938rem] relative"
            alt=""
            src="./indonesia.png"
          />

          <div
            class="w-[4.125rem] relative tracking-[0.03em] font-medium hidden"
          >
            Tìm kiếm
          </div>
        </div>
      ...
      <button
        class="cursor-pointer py-[0.875rem] px-[1.562rem] bg-mediumseagreen-200 w-[5.5rem] rounded-sm box-border overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[0.625rem] z-[2] border-[1px] border-solid border-gainsboro-200"
      >
        <div
          class="relative text-[0.938rem] tracking-[0.03em] font-medium font-roboto text-white text-left inline-block min-w-[2.25rem]"
        >
          Send
        </div>
        <div
        ...
        >
          ...
          <div
            class="w-[4.125rem] relative text-[0.938rem] tracking-[0.03em] font-medium font-roboto text-dimgray text-left hidden"
          >
            Tìm kiếm
          </div>
        </div>
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      class="absolute top-[0.395rem] left-[0.156rem] rounded-sm bg-mediumseagreen-200 w-[0.338rem] h-[0.338rem] [transform:_rotate(-45deg)] [transform-origin:0_0]"
                    ></div>
                    <div
                      class="absolute top-[0.398rem] left-[0rem] rounded-sm box-border w-[0.563rem] h-[0.563rem] [transform:_rotate(-45deg)] [transform-origin:0_0] z-[1] border-[1px] border-solid border-mediumseagreen-200"
                    ></div>
                  </div>
                </div>
                <b
                  class="flex-1 relative tracking-[0.03em] shrink-0 [debug_commit:1de1738]"
                  >HA NOI</b
                >
              </div>
              <div
              ...
              >
                <div class="relative tracking-[0.03em]">
                  <p class="m-0">
                    12Ath floor, B Tower, Handiresco Building, 521 Kim Ma, Ba
                    Dinh, Hanoi, Vietnam
                  </p>
                  <p class="m-0">
                    <b class="font-roboto">+ Tel:</b>
                    <span> 024.38566688</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <p class="m-0">
                    25th Floor, Lim Tower,9-11 Ton Duc Thang Str., Ben Nghe
                    Ward,1St Dist., Ho Chi Minh City, Viet Nam
                  </p>
                  <p class="m-0">
                    <b class="font-roboto">+ Tel:</b>
                    <span> 024.38566688</span>
          ...
          <img
            class="w-[13.044rem] h-[3.825rem] relative object-contain"
            loading="lazy"
            alt=""
            src="./indonesia.png"
          />
        ...
        <div
          class="flex-1 flex flex-col items-start justify-start gap-[1.25rem] min-w-[29.063rem] max-w-full mq825:min-w-full"
        >
          <div
            class="w-[44rem] flex flex-col items-start justify-start gap-[0.625rem] max-w-full"
          >
            <div
              class="relative tracking-[0.03em] uppercase font-semibold inline-block min-w-[6.75rem] shrink-0 [debug_commit:1de1738] mq450:text-[1rem]"
            >
              PRODUCTS
            </div>
            <img
        ...
        >
          ...
          >
            <div class="flex flex-row items-start justify-start gap-[1.25rem]">
              <img
                class="h-[2.844rem] w-[2.844rem] relative min-h-[2.875rem]"
                loading="lazy"
                alt=""
                src="./indonesia.png"
              />
    ...
    >
      ...
      <div
        class="w-[32.131rem] flex flex-row items-start justify-center gap-[2.281rem] max-w-full mq825:flex-wrap mq825:gap-[1.125rem]"
      >
        <div
          class="flex-1 flex flex-row items-center justify-start min-w-[2.813rem]"
        >
          <img
            class="h-[0.731rem] w-[4.288rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
        <div
          class="flex-1 flex flex-row items-center justify-start min-w-[2.563rem]"
        >
          <img
            class="h-[0.806rem] w-[3.863rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
        ...
        >
          <img
            class="h-[0.744rem] w-[3.919rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
        <div class="flex flex-row items-center justify-start">
          <img
            class="h-[0.688rem] w-[2.938rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
        <div class="flex flex-row items-center justify-start">
          <img
            class="h-[0.806rem] w-[2.775rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
        <div class="flex flex-row items-center justify-start">
          <img
            class="h-[0.806rem] w-[2.944rem] relative"
            alt=""
            src="./indonesia.png"
          />
        </div>
